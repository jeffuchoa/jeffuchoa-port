          ...
          <div className="skills_inner">
            <div className="left">
              ...
              <div className="text wow fadeInUp" data-wow-duration=".7s">
                <p>
                  Tenho mais de 4 anos de experiência em desenvolvimento Front-end, Back-end e UI/UX, eu foco em fazer sites com uma experiência completa inicando pela prototipação até o desenvolvimento final do site por código
                </p>
              </div>
              <div
